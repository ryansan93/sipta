	...
	<div class="col-lg-12 detailed">
		<form role="form" class="form-horizontal">
			...
			<?php if ( $akses['a_submit'] == 1 ): ?>
					<button id="btn-add" type="button" class="btn btn-primary cursor-p" title="ADD" onclick="um.add_form(this)"> 
			...
			<div class="col-lg-2 search pull-right">
				<select class="form-control" type="search" onchange="filter_all(this, true)" data-table="tbl_user">
