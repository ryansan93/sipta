<div class="col-xs-12 no-padding" style="margin-bottom: 5px;">
	...
	<div class="col-xs-12 no-padding prodi" data-val="<?php echo $data['prodi_kode']; ?>" style="padding-left: 15px;">
...
<div class="col-xs-12 no-padding" style="margin-bottom: 5px;">
	...
	<div class="col-xs-12 no-padding judul_penelitian" data-val="<?php echo $data['judul_penelitian']; ?>" style="padding-left: 15px;">
