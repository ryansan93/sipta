<!-- <div class="col-xs-12 no-padding" style="margin-bottom: 5px;">
	...
	<div class="col-xs-12 no-padding">
		<div class="input-group date datetimepicker" name="tglPengajuan" id="TglPengajuan">
...
<?php for ($i=0; $i < 2; $i++) { ?>
	<div class="col-xs-12 no-padding pembimbing" data-no="<?php echo $i+1; ?>" style="margin-bottom: 5px;">
		...
		<div class="col-xs-12 no-padding">
			...
			<div class="col-xs-12 no-padding">
				<input type="text" class="form-control no_telp_pembimbing" placeholder="No. Telp" data-required="1">
			</div>
		</div>
	</div>
<?php } ?>
