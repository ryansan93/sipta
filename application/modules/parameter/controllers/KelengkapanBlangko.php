...
class KelengkapanBlangko extends Public_Controller {

    private $pathView = 'parameter/kelengkapan_blangko/';
    private $url;
    private $hakAkses;
    ...
    public function index($segment=0)
    {
        if ( $this->hakAkses['a_view'] == 1 ) {
            $this->add_external_js(array(
                ...
                "assets/parameter/kelengkapan_blangko/js/kelengkapan-blangko.js",
            ));
            $this->add_external_css(array(
                "assets/parameter/kelengkapan_blangko/css/kelengkapan-blangko.css",
            ));
            ...
            $content['data'] = $d_kp;
            $content['title_panel'] = 'Master Kelengkapan Blangko';

            // Load Indexx
            $data['title_menu'] = 'Master Kelengkapan Blangko';
