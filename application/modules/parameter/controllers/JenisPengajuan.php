...
class JenisPengajuan extends Public_Controller {

    private $pathView = 'parameter/jenis_pengajuan/';
    private $url;
    private $hakAkses;
    ...
    public function index($segment=0)
    {
        if ( $this->hakAkses['a_view'] == 1 ) {
            $this->add_external_js(array(
                ...
                "assets/parameter/jenis_pengajuan/js/jenis-pengajuan.js",
            ));
            $this->add_external_css(array(
                "assets/parameter/jenis_pengajuan/css/jenis-pengajuan.css",
            ));
            ...
            $content['data'] = $d_jp;
            $content['title_panel'] = 'Master Jenis Pengajuan';

            // Load Indexx
            $data['title_menu'] = 'Master Jenis Pengajuan';
