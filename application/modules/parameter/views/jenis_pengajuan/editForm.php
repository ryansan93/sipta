<div class="modal-header header" style="padding-left: 8px; padding-right: 8px;">
	<span class="modal-title">Edit Jenis Pengajuan</span>
					...
					<tr>
						...
						<td class="col-sm-10">
							<select class="form-control form col-sm-6" data-required="1">
								...
								<option value="kompre" <?php echo ($data['form'] == 'kompre') ? 'selected' : ''; ?> >KOMPRE</option>
								<option value="semhas" <?php echo ($data['form'] == 'semhas') ? 'selected' : ''; ?> >SEMHAS</option>
							</select>
						</td>
					</tr>
				</tbody>
