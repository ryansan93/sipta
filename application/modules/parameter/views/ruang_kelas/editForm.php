<div class="modal-header header" style="padding-left: 8px; padding-right: 8px;">
	<span class="modal-title">Edit Ruang Kelas</span>
...
<div class="modal-body body">
	<div class="row">
			...
			<table class="table no-border" style="margin-bottom: 0px;">
				<tbody>
					<tr>
						...
						<td class="col-sm-10">
							<input type="text" class="col-sm-2 form-control kode uppercase" placeholder="Kode" maxlength="10" data-required="1" value="<?php echo $data['kode']; ?>" readonly>
						</td>
					</tr>
					<tr>
						<td class="col-sm-2">				
		...
		<div class="col-sm-12 no-padding" style="padding-left: 8px; padding-right: 8px;">
			<hr>
			<button type="button" class="btn btn-primary pull-right" onclick="rk.edit(this)" data-kode="<?php echo $data['kode']; ?>">
