var rk = {
	...
	modalAddForm: function () {
        ...
        $.get('parameter/RuangKelas/modalAddForm',{
        },function(data){
            var _options = {
                className : 'large',
                message : data,
	...
	modalEditForm: function (elm) {
        ...
        $.get('parameter/RuangKelas/modalEditForm',{
    ...
    delete: function(elm) {
		...
		bootbox.confirm('Apakah anda yakin ingin meng-hapus data ?', function(result) {
			if ( result ) {
		        ...
		        $.ajax({
		            url: 'parameter/RuangKelas/delete',
		            data: {
		                'kode': kode
		            },
		            type: 'POST',
